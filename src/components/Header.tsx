    ...
    <header className="h-16 border-b bg-card/50 backdrop-blur-sm flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <Button variant="ghost" size="icon" className="relative">
          ...
          <Badge className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-primary text-xs p-0 flex items-center justify-center">
            3
          </Badge>
        </Button>
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="gap-2 h-10">
              ...
              <div className="text-left">
                <p className="text-sm font-medium">Admin OWL</p>
